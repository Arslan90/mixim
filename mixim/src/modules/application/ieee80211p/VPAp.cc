...
void VPAp::initialize(int stage) {
...
void VPAp::handleSelfMsg(cMessage* msg) {
	switch (msg->getKind()) {
...
void VPAp::handleLowerMsg(cMessage* msg) {
...
void VPAp::sendVPApBroadcast(int messageSequence) {
...
WaveShortMessage*  VPAp::prepareWSM(std::string name, int lengthBits, t_channel channel, int priority, int rcvId, int serial) {
...
void VPAp::onBeacon(WaveShortMessage* wsm) {
}

void VPAp::onData(WaveShortMessage* wsm) {
}
