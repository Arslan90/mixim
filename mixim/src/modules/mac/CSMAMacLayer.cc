...
void CSMAMacLayer::scheduleBackoff()
{
    ...
    if(macQueue.size() != 0) {
        ...
        //time = 0; //ARTURO, Change this for provoke collisions.
        ...
        debugEV << " Slots: " << slots  << " time: " << time << " nbBackoffs:" << nbBackoffs <<" backoffValues:" << backoffValues <<endl; //ARTURO, added this..
