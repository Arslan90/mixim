...
#ifndef MOBILITY_LEG_GEOTRACI_GEOTRACIMOBILITY_H
#define MOBILITY_LEG_GEOTRACI_GEOTRACIMOBILITY_H
 ...
 */
class LEG_GeoTraCIMobility : public TraCIMobility
{
	public:
		class Statistics {
			public:
	    ...
	    LEG_GeoTraCIMobility() : TraCIMobility(), isPreInitialized(false) {}
...
class LEG_DtnNetwLayerGeoTraCIMobilityAccess
{
	public:
	LEG_GeoTraCIMobility* get(cModule* host) {
		LEG_GeoTraCIMobility* traci = FindModule<LEG_GeoTraCIMobility*>::findSubModule(host);
			ASSERT(traci);
			return traci;
		};
};
