...
Define_Module(LEG_DtnNetwLayer);

void LEG_DtnNetwLayer::initialize(int stage)
{
...
bool LEG_DtnNetwLayer::ackExist(WaveShortMessage *msg)
{
	bool exist = false;
...
bool LEG_DtnNetwLayer::ackExist(BundleMeta bndlMeta)
{
	bool exist = false;
...
bool LEG_DtnNetwLayer::existAndErase(BundleMeta bndlMeta)
{
	bool found = false;
...
void LEG_DtnNetwLayer::storeBundle(WaveShortMessage *msg)
{
...
void LEG_DtnNetwLayer::storeACK(BundleMeta meta)
{
...
LAddress::L3Type LEG_DtnNetwLayer::getAddressFromName(const char *name)
{
	int addr = 0;
	if (strcmp(name,"")!=0){
		...
		opp_error("getting address from name return NULL (LEG_DtnNetwLayer::getAddressFromName)");
	}
	return addr;
}
...
double LEG_DtnNetwLayer::getTimeFromName(const char *name)
{
	double time = 0;
	if (strcmp(name,"")!=0){
		std::istringstream iss(name);
		...
		opp_error("getting time from name return NULL (LEG_DtnNetwLayer::getTimeFromName)");
	}
	return time;
}
...
void LEG_DtnNetwLayer::deleteOldBundle(int ttl)
{
...
void LEG_DtnNetwLayer::handleUpperMsg(cMessage *msg)
{
...
void LEG_DtnNetwLayer::handleLowerMsg(cMessage *msg)
{
...
void LEG_DtnNetwLayer::handleSelfMsg(cMessage *msg)
{
	switch (msg->getKind()) {
		case RESTART:
			break;
...
void LEG_DtnNetwLayer::handleLowerControl(cMessage *msg)
{
	if (isEquiped) {
...
void LEG_DtnNetwLayer::handleUpperControl(cMessage *msg)
{
...
bool LEG_DtnNetwLayer::haveToRestartIEP(simtime_t t)
{
...
bool LEG_DtnNetwLayer::forceRestartIEP(LAddress::L3Type addr)
{
	bool haveToRestartIEP = false;
	stringstream ss;
	ss << addr;
...
unsigned long LEG_DtnNetwLayer::generateContactSerial(int myAddr, int seqNumber, int otherAddr)
{
...
unsigned long LEG_DtnNetwLayer::startRecordingContact(int addr, double time)
{
...
unsigned long LEG_DtnNetwLayer::startRecordingContact(int addr, unsigned long  contactID)
{
	/*
...
unsigned long LEG_DtnNetwLayer::endRecordingContact(int addr, double time)
{
...
unsigned long LEG_DtnNetwLayer::endRecordingContact(unsigned long  contactID, bool hasForcedEnding)
{
...
void LEG_DtnNetwLayer::recordBeginContactStats(LAddress::L3Type addr, double time)
{
...
void LEG_DtnNetwLayer::recordEndContactStats(LAddress::L3Type addr, double time)
{
...
void LEG_DtnNetwLayer::recordRecontactStats(LAddress::L3Type addr, double time)
{
...
void LEG_DtnNetwLayer::classify(SimpleContactStats *newContact)
{
	/*
...
void LEG_DtnNetwLayer::classifyAll()
{
...
void LEG_DtnNetwLayer::initAllClassifier()
{
...
void LEG_DtnNetwLayer::recordClassifier(ClassifiedContactStats classifier)
{
...
bool LEG_DtnNetwLayer::erase(WaveShortMessage *msg)
{
	bool found = false;
...
bool LEG_DtnNetwLayer::erase(unsigned long serial)
{
	bool found = false;
...
void LEG_DtnNetwLayer::recordAllClassifier()
{
	if (withGlobal){
...
void LEG_DtnNetwLayer::recordAllScalars()
{
...
void LEG_DtnNetwLayer::resetStatPerVPA()
{
...
bool LEG_DtnNetwLayer::isMeetVpa() const
{
    return meetVPA;
}

std::string LEG_DtnNetwLayer::BundleSentPerVpaSerialToString() const
{
...
long LEG_DtnNetwLayer::getNbrCountForMeanNeighbors() const
{
    return nbrCountForMeanNeighbors;
}

long LEG_DtnNetwLayer::getNbrNeighors() const
{
    return nbrNeighors;
}

bool LEG_DtnNetwLayer::isHadBundles() const
{
    return hadBundles;
}

std::pair<double,double> LEG_DtnNetwLayer::VPAContactDuration()
{
	double total = 0.0;
	double count = 0.0;
...
std::pair<double,double> LEG_DtnNetwLayer::VPAContactDistance()
{
	double total = 0.0;
	double count = 0.0;
...
void LEG_DtnNetwLayer::DefineNodeType()
{
	...
	if (parentModule->findSubmodule("appl")!=-1){
		...
		if (VPAModule != NULL){
			...
			opp_error("LEG_DtnNetwLayer::DefineNodeType() - Unable to define NodeType please check existence of appl module in NED file");
		}
	}
}

int LEG_DtnNetwLayer::getCurrentSector()
{
	...
	switch (nodeType) {
		...
		case VPA:
			...
			break;
		default:
			opp_error("LEG_DtnNetwLayer::getCurrentSector() - Unable to define CurrentSector due to unknown node type");
			break;
	}
...
Coord LEG_DtnNetwLayer::getCurrentPos()
{
...
void LEG_DtnNetwLayer::updateNeighborhoodTable(LAddress::L3Type neighbor, NetwRoute neighborEntry)
{
...
bool LEG_DtnNetwLayer::exist(WaveShortMessage *msg)
{
	return exist(msg->getSerial());
}

bool LEG_DtnNetwLayer::exist(BundleMeta bndlMeta)
{
	return exist(bndlMeta.getSerial());
}

bool LEG_DtnNetwLayer::exist(unsigned long  serial)
{
	bool found = false;
...
std::vector<std::pair<WaveShortMessage*,int> > LEG_DtnNetwLayer::compAsFn_schedulingStrategy(std::vector<std::pair<WaveShortMessage*,int> > vectorToSort)
{
...
void LEG_DtnNetwLayer::sendDown(cMessage *msg)
{
	BaseLayer::sendDown(msg);
	updatingL3Sent();
}

void LEG_DtnNetwLayer::sendDown(cMessage *msg, long HelloCtrlLength, long OtherCtrlLength, short nbrEncapData)
{
...
void LEG_DtnNetwLayer::storeAckSerial(unsigned long  serial)
{
	if (withAck){
		if (withTTLForCtrl){
...
void LEG_DtnNetwLayer::storeAckSerials(std::set<unsigned long > setOfSerials)
{
	if (withAck){
...
void LEG_DtnNetwLayer::deletedAckSerials(){
...
WaveShortMessage* LEG_DtnNetwLayer::getStoredWSMFromSerial(unsigned long serial){
...
void LEG_DtnNetwLayer::prepareNetwPkt(DtnNetwPkt* myNetwPkt, short  kind, LAddress::L3Type destAddr)
{
	int realPktLength = 0;
...
std::vector<WaveShortMessage* > LEG_DtnNetwLayer::scheduleFilterBundles(std::vector<std::pair<WaveShortMessage*,int> > unsortedWSMPair, LAddress::L3Type destAddr, int destType){
...
void LEG_DtnNetwLayer::emitSignalForHelloCtrlMsg(long  sizeHC_SB_Octets, long  sizeHC_SA_Octets, long  sizeHC_CL_Octets, long  sizeHC_RCC_Octets)
{
...
void LEG_DtnNetwLayer::emitSignalForOtherCtrlMsg(long  sizeOC_SB_Octets, long  sizeOC_SA_Octets, long  sizeOC_CL_Octets, long  sizeOC_RCC_Octets)
{
